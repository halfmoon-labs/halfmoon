...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open Halfmoon console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About Halfmoon",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit Halfmoon",
		Exiting:            "Exiting Halfmoon...",
		DocUrl:             "https://docs.picoclaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 Halfmoon 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 Halfmoon",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 Halfmoon",
		Exiting:            "正在退出 Halfmoon...",
