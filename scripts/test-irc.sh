...
CONTAINER_NAME="halfmoon-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.halfmoon/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run halfmoon:"
echo "  cd packages/halfmoon && go run ./cmd/halfmoon gateway"
echo ""
