...
func (a *App) newHomePage() tview.Primitive {
	...
	rebuildList := func() {
		...
		list.AddItem("QUIT SYSTEM", "Exit Halfmoon Launcher", 'q', func() { a.tapp.Stop() })
