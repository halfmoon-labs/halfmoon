...
import (
	...
	tuicfg "github.com/halfmoon-labs/halfmoon/cmd/halfmoon-launcher-tui/config"
	"github.com/halfmoon-labs/halfmoon/cmd/halfmoon-launcher-tui/ui"
)
...
func main() {
	...
	if _, err := os.Stat(configDir); os.IsNotExist(err) {
		cmd := exec.Command("halfmoon", "onboard")
		cmd.Stdin = os.Stdin
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "halfmoon-launcher-tui: %v\n", err)
		os.Exit(1)
	}
