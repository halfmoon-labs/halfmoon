...
// Package config provides types and I/O for ~/.halfmoon/tui.toml.
package config
...
func DefaultConfigPath() string {
	...
	return filepath.Join(home, ".halfmoon", "tui.toml")
}

// TUIConfig is the top-level structure of ~/.halfmoon/tui.toml.
...
// SyncSelectedModelToMainConfig syncs the currently selected model to ~/.halfmoon/config.json
...
func SyncSelectedModelToMainConfig(scheme Scheme, user User, modelID string) error {
	...
	mainConfigPath := filepath.Join(home, ".halfmoon", "config.json")
