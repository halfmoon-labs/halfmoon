...
Examples:
  halfmoon model                    # Show current default model
  halfmoon model gpt-5.2           # Set gpt-5.2 as default
  halfmoon model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  halfmoon model local-model       # Set local VLLM server as default
