...
import (
	...
	"github.com/halfmoon-labs/halfmoon/pkg/channels/weixin"
...
to authorize your account. On success, the bot token is saved to the halfmoon
...
func printManualWeixinConfig(token, baseURL string) {
	fmt.Println()
	fmt.Println("Add the following to the channels section of your halfmoon config:")
	fmt.Println()
	fmt.Println(`  "weixin": {`)
