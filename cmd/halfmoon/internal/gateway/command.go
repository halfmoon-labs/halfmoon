...
import (
	...
	"github.com/halfmoon-labs/halfmoon/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return gateway.Run(debug, internal.GetHalfmoonHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
