...
func onboard(encrypt bool) {
	...
	fmt.Println("\nNext steps:")
	if encrypt {
		fmt.Println("  1. Set your encryption passphrase before starting halfmoon:")
		fmt.Println("       export HALFMOON_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS")
		fmt.Println("       set HALFMOON_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd")
		fmt.Println("")
	...
	fmt.Println("")
	fmt.Println("  3. Chat: halfmoon agent -m \"Hello!\"")
}
...
// setupSSHKey generates the halfmoon-specific SSH key at ~/.ssh/halfmoon_ed25519.key.
