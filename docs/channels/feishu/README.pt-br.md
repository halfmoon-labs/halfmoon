...
5. Preencha o App ID e o App Secret no arquivo de configuração do Halfmoon
6. Execute `halfmoon gateway` para iniciar o serviço
7. Pesquise o nome do bot no Feishu e inicie uma conversa

> O Halfmoon se conecta ao Feishu usando o modo WebSocket/SDK — nenhum endereço de callback público ou URL de Webhook é necessário.
>
