...
O Halfmoon oferece suporte ao QQ via API Bot oficial da Plataforma Aberta QQ.
...
3. Preencha as credenciais no arquivo de configuração do Halfmoon
4. Execute `halfmoon gateway` para iniciar o serviço
...
4. Preencha as credenciais no arquivo de configuração do Halfmoon
5. Execute `halfmoon gateway` para iniciar o serviço
