...
Halfmoon prend en charge QQ via l'API Bot officielle de la plateforme ouverte QQ.
...
3. Renseigner les identifiants dans le fichier de configuration Halfmoon
4. Exécuter `halfmoon gateway` pour démarrer le service
...
4. Renseigner les identifiants dans le fichier de configuration Halfmoon
5. Exécuter `halfmoon gateway` pour démarrer le service
