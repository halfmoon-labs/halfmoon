...
Halfmoon hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình Halfmoon
4. Chạy `halfmoon gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình Halfmoon
5. Chạy `halfmoon gateway` để khởi động dịch vụ
