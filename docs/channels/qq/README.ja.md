...
Halfmoon は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. Halfmoon 設定ファイルに認証情報を入力する
4. `halfmoon gateway` を実行してサービスを起動する
...
4. Halfmoon 設定ファイルに認証情報を入力する
5. `halfmoon gateway` を実行してサービスを起動する
