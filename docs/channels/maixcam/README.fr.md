...
Le canal MaixCam permet à Halfmoon de fonctionner comme backend IA pour les appareils en périphérie :

- **Surveillance intelligente** : MaixCAM envoie des images ; Halfmoon les analyse via des modèles de vision
- **Contrôle IoT** : Les appareils envoient des données de capteurs ; Halfmoon coordonne les réponses
- **IA hors ligne** : Déployer Halfmoon sur un réseau local pour une inférence à faible latence
