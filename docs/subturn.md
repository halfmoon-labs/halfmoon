...
The `SubTurn` mechanism is a core feature in Halfmoon that allows tools to spawn isolated, nested agent loops to handle complex sub-tasks.
...
SubTurns emit specific events to the Halfmoon `EventBus` for observability and debugging:
