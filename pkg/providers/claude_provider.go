...
import (
	...
	anthropicprovider "github.com/halfmoon-labs/halfmoon/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: halfmoon auth login --provider anthropic")
		}
