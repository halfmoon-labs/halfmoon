...
// (e.g., the channel manager's HTTP server) instead of the health server's own listener.
// The server is marked as ready immediately since the caller manages the HTTP lifecycle.
